...
export function renderLossFunction(container) {
  container.innerHTML = `
    ...
    <div class="steps-section" style="margin-top:40px;">
      <div class="steps-header">
        <span class="mono-label">[ 07_LOSS_ARCHITECTURE ]</span>
        <h3 style="font-size:1.8rem; font-weight:800; letter-spacing:-0.03em; margin-bottom:12px;">Quantifying Error</h3>
        <p style="color:var(--text-muted); font-size:1rem; max-width:600px;">A model cannot improve if it doesn't know how far it is from the truth. The loss function is the mathematical compass for optimization.</p>
      </div>
          </p>
        </div>
      </div>
